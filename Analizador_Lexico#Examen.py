...
def analizar_codigo():
    ...
    tk.Label(tabla, text="LEXEMA", bg='yellow').grid(row=0, column=0, padx=5, pady=5)
    tk.Label(tabla, text="PALABRA_R", bg='yellow').grid(row=0, column=1, padx=5, pady=5)
    tk.Label(tabla, text="IDENTIFICADOR", bg='yellow').grid(row=0, column=2, padx=5, pady=5)
    tk.Label(tabla, text="OPERADOR", bg='yellow').grid(row=0, column=3, padx=5, pady=5)
    tk.Label(tabla, text="NUMERO", bg='yellow').grid(row=0, column=4, padx=5, pady=5)
    tk.Label(tabla, text="SIMBOLO", bg='yellow').grid(row=0, column=5, padx=5, pady=5)
...
ventana_principal.configure(bg='lightgreen')  # Cambiar el color de fondo principal

# Panel de entrada de código
panel_codigo = tk.Frame(ventana_principal, bg='lightgreen')  # Cambiar el color de fondo del panel
panel_codigo.grid(row=0, column=1, padx=10, pady=10)

codigo_text = tk.Text(panel_codigo, height=35, width=60, bg='white')  # Cambiar el color de fondo del área de texto
codigo_text.insert(tk.END, "area=(base*altura)/2\ncarlos emmenuel carrasco zavala 10 de octubre del 2003")
codigo_text.grid(row=2, column=2, padx=10, pady=10)

# Botón de análisis léxico
boton_analizar = tk.Button(panel_codigo, text="Analizar", command=analizar_codigo, bg='white')  # Cambiar el color del botón
boton_analizar.grid(row=1, column=1, pady=5)

# Panel de resultados
panel_resultados = tk.Frame(ventana_principal, bg='lightgreen')  # Cambiar el color de fondo del panel
panel_resultados.grid(row=0, column=0, padx=10, pady=10)
